...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/business": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Business update data (BusinessName, Phone, ServiceCategory, Industry - all optional)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/businesses/multi": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Multi-staff business data (BusinessName, Phone, ServiceCategory, Industry)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/locations": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Location data (Name, Address, City, State, Country, PostalCode, Latitude, Longitude, PhoneNumber)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/locations/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Location update data (all fields optional - Name, Address, City, State, Country, PostalCode, Latitude, Longitude, PhoneNumber)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/services": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Xidmet melumatlari",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_service.CreateServiceHTTPRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Xidmet yaradildi",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_service.SuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Validasiya xetasi",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_service.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/services/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Service update data (all fields optional - Name, Description, Duration, Price, IsActive)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/staff": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Staff profile data (FirstName, LastName, Email, Phone, Specializations - optional)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/staff/invites": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Invitation details (FirstName, LastName, Email, Phone, Role - provider_owner, staff, customer)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/staff/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Staff update data (all fields optional - FirstName, LastName, Email, Phone, Specializations, IsActive)",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/availability": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Xidmet ID (mueddet bundan goturulur)",
                        "name": "service_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Baslangic tarixi YYYY-MM-DD",
                        "name": "from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Bitis tarixi YYYY-MM-DD",
                        "name": "to",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_availability.SuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_availability.ErrorResponse"
                        }
                    }
                }
            }
        ...
        "/availability/settings": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Isci ID (bos olsa biznes default-u)",
                        "name": "staff_id",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_availability.UpdateScheduleSettingsRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_availability.CreateTimeOffRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/availability/working-hours": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Heftelik qrafik",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_availability.BulkWorkingHoursRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Is saatlari",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_availability.SetWorkingHoursRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/bookings": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Musteri ID",
                        "name": "customer_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "pending|confirmed|reschedule_proposed|cancelled|completed|no_show",
                        "name": "status",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "RFC3339 ve ya YYYY-MM-DD",
                        "name": "from",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_booking.SuccessResponse"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.CreateBookingRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "Vaxt artiq tutulub",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_booking.ErrorResponse"
                        }
                    }
                }
            }
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.UpdateBookingRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.CancelBookingRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/bookings/{id}/propose": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Yeni vaxt",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.ProposeRescheduleRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.RespondToProposalRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/customers/self": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Biznes ID",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_customer.ResolveSelfRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_customer.SuccessResponseDTO"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/dashboard/stats": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "IANA timezone (default Asia/Baku)",
                        "name": "tz",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_dashboard.SuccessResponse"
                        }
                    },
                    "403": {
                        "description": "Forbidden",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_dashboard.ErrorResponse"
                        }
                    }
                }
            }
        ...
        "/notifications": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "boolean",
                        "description": "Yalniz oxunmamislar",
                        "name": "unread",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_notification.SuccessResponse"
                        }
                    }
                }
            }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_notification.RegisterDeviceRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_http_handlers_public.SuccessResponse"
                        }
                    }
                }
            }
        ...
        "/public/businesses": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Sahe uzre filtr (mes. Berber)",
                        "name": "category",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Ad / sahe uzre axtaris",
                        "name": "q",
                        "in": "query"
                    }
                ],
        ...
        "/public/businesses/{id}/services": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Yalniz bu iscinin xidmetleri",
                        "name": "staff_id",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_availability.BulkWorkingHoursRequest": {
            "type": "object",
            "properties": {
                "days": {
                    "type": "array",
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_availability.CreateTimeOffRequest": {
            "type": "object",
            "properties": {
                "end_at": {
                    "type": "string"
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_availability.SetWorkingHoursRequest": {
            "type": "object",
            "properties": {
                "break_enabled": {
                    "type": "boolean"
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_availability.UpdateScheduleSettingsRequest": {
            "type": "object",
            "properties": {
                "allow_customer_reschedule": {
                    "type": "boolean"
                },
                "allow_reschedule_proposal": {
                    "type": "boolean"
                },
                "auto_confirm": {
                    "type": "boolean"
                ...
                "pending_expires_mins": {
                    "type": "integer"
                },
                "reschedule_window_mins": {
                    "type": "integer"
                },
                "slot_step_mins": {
                    "type": "integer"
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.CancelBookingRequest": {
            "type": "object",
            "properties": {
                "reason": {
                    "type": "string"
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.CreateBookingRequest": {
            "type": "object",
            "properties": {
                "customer_id": {
                    "type": "string"
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.ProposeRescheduleRequest": {
            "type": "object",
            "properties": {
                "new_start_time": {
                    "type": "string"
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.RespondToProposalRequest": {
            "type": "object",
            "properties": {
                "accept": {
                    "type": "boolean"
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_booking.UpdateBookingRequest": {
            "type": "object",
            "properties": {
                "notes": {
                    "type": "string"
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_notification.Platform": {
            "type": "string",
            "enum": [
                "ios",
                "android",
        ...
        "github_com_OrkhanNajaf1i_booking-service_internal_domain_notification.RegisterDeviceRequest": {
            "type": "object",
            "properties": {
                "platform": {
                    "$ref": "#/definitions/github_com_OrkhanNajaf1i_booking-service_internal_domain_notification.Platform"
                },
                "token": {
                    "type": "string"
                }
        ...
        "internal_http_handlers_availability.ErrorResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_http_handlers_availability.SuccessResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_http_handlers_booking.ErrorResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_http_handlers_booking.SuccessResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_http_handlers_customer.ResolveSelfRequest": {
            "type": "object",
            "properties": {
                "business_id": {
                    "type": "string"
        ...
        "internal_http_handlers_customer.SuccessResponseDTO": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_http_handlers_dashboard.ErrorResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
        ...
        "internal_http_handlers_dashboard.SuccessResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_http_handlers_notification.SuccessResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_http_handlers_public.SuccessResponse": {
            "type": "object",
            "properties": {
                "data": {},
                "message": {
        ...
        "internal_http_handlers_service.CreateServiceHTTPRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string",
                    "example": "Kisi sac kesimi"
                },
                "duration_minutes": {
                    "type": "integer",
                    "example": 30
